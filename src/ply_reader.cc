...
void read_vertices (const std::string & nombre_archivo_pse, vector<Tupla3f> &   vertices) {
   unsigned
      num_vertices = 0,
      num_caras   = 0 ;
   ifstream
...
void leer_vertices (unsigned num_vertices, vector<Tupla3f> & vertices, ifstream & src)
{
   char
